			...
			for(int i = 0; i < this.sheetData.size(); i++)
			{
				...
				switch(firstColumn)
				{
					  ...
					  case  "contactUs": contactUs(); break; 
						/*
						 * case "aboutSkillupOnline": aboutSkillupOnline(); break; case "business":
						 * business(); break; case "faq": faq(); break; case "privacyPolicy":
						 * privacyPolicy(); break; case "termsOfservice": verifyTermsofService(); break;
						 * case "blog": verifyBlog(row); break; case "popularCategories":
						 * verifyPopularCategories(); break; case "popularCourses":
						 * verifyPopularCourses(); break; case "latestBlogs": verifyLatestBlogs();
						 * break;
						 */
				}
			}
