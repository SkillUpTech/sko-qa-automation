...
public class FutureSkillValidation
{
	...
	public String start() throws InterruptedException
	{
		...
		for(String win : windows)
		{
			...
			{
				driver.switchTo().window(win);
				if(driver.getCurrentUrl().equalsIgnoreCase(com.seo.sanityTesting.OpenWebsite.setURL+"/"))
				{
					driver.switchTo().window(win);
					driver.close();
				...
				else if(!driver.getCurrentUrl().equalsIgnoreCase(com.seo.sanityTesting.OpenWebsite.setURL+"/"))
				{
					driver.switchTo().window(win);
					driver.close();
					driver.switchTo().window(BaseWindow);
